...
A tela **Livro de Registro** agora tem filtros: **paciente**, **período (de/até)**, **tipo de movimento** (entradas, saídas, devoluções, **ajustes de inventário**), **substância**, **lista/classe** (controlados) e **lote**. As colunas **Lote** e **Validade** aparecem na tela e no impresso. Os filtros valem para a tela e para a impressão — o subtítulo do impresso descreve o recorte aplicado. Importante: o **Saldo após** continua sendo o saldo **real** acumulado sobre todos os lançamentos; os filtros só escolhem quais linhas aparecem, nunca recalculam o saldo dentro do recorte. Só front, sem migração.
